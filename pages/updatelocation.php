    ...
    <main>
        <?php
            if($_SESSION["validate"] == "validated"){
                ...
                echo'
                <form class="allform" action="actionupdatelocation.php" method="post">
                    <input type="text" name="updatedcity" placeholder="Enter City"><br>
                    <input type="hidden" name="LocationID" value="'. htmlspecialchars($LocationID).'"><br>
